<%-- 
    Document   : news
    Created on : Apr 22, 2024, 1:27:56 PM
    Author     : admin
--%>
...
<html>
    ...
    <body>
        ...
        <h1 class="header">News Information</h1>
        <div class="container">
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>${n.name}</td>
                                    <td>${n.time}</td>
                                    <td><a href="<%=request.getContextPath()%>/newdetail?id=${n.id}">View</a></td>
                                </tr>
        ...
        <script>
            ...
            function updateUrl(id) {
                window.location.href = "http://localhost:9999/PRJ301-Project/news?page=" + id;
            }
